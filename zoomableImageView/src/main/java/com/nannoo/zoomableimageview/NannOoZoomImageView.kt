package com.nannoo.zoomableimageview
...
class NannOoZoomImageView : AppCompatImageView {
    ...
    private fun initView() {
        ...
        tapDetector = GestureDetector(context, object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                onClickListener?.onClick(this@NannOoZoomImageView)
                return true
            }

            override fun onLongPress(e: MotionEvent) {
                onLongClickListener?.onLongClick(this@NannOoZoomImageView)
            }
            ...
            override fun onFling(
                ...
                this@NannOoZoomImageView.postOnAnimation(flingRunnable)
                return true
            }
    ...
    private val flingRunnable = object : Runnable {
        ...
        override fun run() {
            if (!scroller.isFinished && scroller.computeScrollOffset()) {
                ...
                lastX = curX
                lastY = curY
                this@NannOoZoomImageView.postOnAnimation(this)
            }
        }
    }
...
////                    if(fistTimeGestureScale) {
////                        onDismiss.invoke()
////                    }
//                } else {
//                    fistTimeGestureScale = true
//                    animatePan(currentTransY, dismissProgress)
//                }
//            }
//        }
...
//    var fistTimeGestureScale = false
//    var onDismiss: () -> Unit = {}
...
//    private fun animatePan(
//        startY: Float, dismissProgress: Float? = null
//    ) {
//        panAnimator = ValueAnimator.ofFloat(0F, startY, 0F, 0F).apply {
//            duration = VALUE_ANIMATOR_DURATION
//            addUpdateListener {
//                val newX = (0F - 0F) * it.animatedFraction
//                val newY = (startY - 0F) * it.animatedFraction
//                panImage(0F - newX, startY - newY, setAbsolute = true)
//                dismissProgress?.let { progress ->
//                    if (1.0F - it.animatedFraction < progress) {
//                        dismissProgressListener.invoke(1.0F - it.animatedFraction)
//                    }
